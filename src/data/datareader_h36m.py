...
class DataReaderH36M(object):
    def __init__(
        ...
        dt_file='h36m_cpn_cam_source.pkl'
    ):
    ...
    def get_hw(self):
        ...
        # train_data (1559752, 2) test_data (566920, 2)
    ...
    def get_sliced_data(self):
        # train_data (1559752, 17, 3) test_data (566920, 17, 3)
        train_data, test_data = self.read_2d()
        # train_labels (1559752, 17, 3) test_labels (566920, 17, 3)
